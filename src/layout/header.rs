...
use yew::{function_component, html, Html, MouseEvent, Callback};
        ...
        <div class="bg-white">
            <div class="border py-3 px-6">
                <div class="flex justify-between">
                    ...
                    <div class="ml-2 flex">
                        <button onclick={redirect_login} class="ml-2 flex cursor-pointer items-center gap-x-1 rounded-md border py-2 px-4 hover:bg-gray-100">
